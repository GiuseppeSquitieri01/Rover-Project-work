...
## 
## Makefile     : Chart.mk
## Generated on : Thu Feb 13 18:57:50 2025
...
START_DIR                 = C:\Users\guido\Desktop\CONSEG~1\Matlab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
{$(START_DIR)\Chart_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Chart_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Chart_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Chart_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Chart.obj : "$(START_DIR)\Chart_ert_rtw\Chart.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Chart_ert_rtw\Chart.c"


ert_main.obj : "$(START_DIR)\Chart_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Chart_ert_rtw\ert_main.c"
